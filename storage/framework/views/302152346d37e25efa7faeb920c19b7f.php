						...
						<div class="reg-form-container"> 
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<form id="formLogin" method="POST" action="<?php echo e(url('login-post')); ?>">
										<?php echo csrf_field(); ?>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\Laravel\rest-api-crud\resources\views/login.blade.php ENDPATH**/ ?>