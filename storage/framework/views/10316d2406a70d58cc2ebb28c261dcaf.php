<?xml version="1.0" encoding="UTF-8"?>
	...
	<body id="body" style="background: linear-gradient(to right, rgba(0,0,0, 0.7), rgba(0,0,0, 0.7)) fixed; background-size: cover; background-position: center; background-color:#000000;">
		<header id="header">
		...
		</header><?php /**PATH D:\server\Laravel\rest-api-crud\resources\views/headerLogin.blade.php ENDPATH**/ ?>