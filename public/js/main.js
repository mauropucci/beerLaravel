...
function submitSearch() {
	document.getElementById("IdCitta").value = document.getElementById("IdCittaForm").value;
	document.getElementById("IdMarca").value = document.getElementById("IdMarcaForm").value;
	document.getElementById("IdRecords").value = document.getElementById("IdRecordsForm").value;
	document.getElementById('serchBeers').submit();
	return true;
}



function setPagination(id, currentPage) {
...
function getCheck() {
	...
	Username = trim(document.getElementById("name").value);
